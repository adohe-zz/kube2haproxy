...
type KubeletConfiguration struct {
	...
	// enable ovs network mode
	EnableOVS bool `json:"enableOVS,omitempty"`
	// network name of pods managed by this kubelet
	NetworkName string `json:"networkName,omitempty"`
	// network mode of pods managed by this kubelet(--net option)
