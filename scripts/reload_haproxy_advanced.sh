...
# Note: this script is borrowed from openshift/origin, and has not
# been test in environment yet. This should a more efficient reload
# way, normally reload_haproxy.sh is enough.
set -o nounset
